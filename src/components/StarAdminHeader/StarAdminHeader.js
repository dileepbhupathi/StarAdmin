...
import { BiBookmarkPlus, BiRadioCircle } from "react-icons/bi";
...
export const StarAdminHeader = ({SideNavbar}) => {
  const content = (
    <div>
  ...
  const ProfileContent = (
    <div className="profile-popover-container">
      ...
      <div className="profile-content-container">
        <p className="manage-accounts-content">Manage Accounts</p>
        <p className="change-password-content">Change Password</p>
        <p className="check-inbox-content">Check Inbox</p>
  ...
  return (
    <div className="star-admin-header">
      ...
      <div className="side-navbar-menu" onClick={SideNavbar}>
        <GrMenu/>
      </div>
      <div className="star-admin-help-line-and-country-container">
        <div className="star-admin-help-line-num-container">
          <p className="star-admin-help-line-num">Help : +050 2992 709</p>
        </div>
        <div className="country-menu-container">
          ...
          <p className="star-admin-english">English</p>
        </div>
      </div>
      <div className="star-admin-hearch-serch-bar-container">
      ...
      <div className="star-admin-header-menu-container" onClick={menu}>
        <FiMenu className="star-admin-header-menu-icon" />
      </div>
      {isMenu ? (
        <div className="star-admin-menu-content-container">
          ...
          <p className="star-admin-menu-content">
            <BiRadioCircle className="star-admin-menu-circle-icon" /> Documentation
          </p>
        </div>
      ) : null}
    </div>
